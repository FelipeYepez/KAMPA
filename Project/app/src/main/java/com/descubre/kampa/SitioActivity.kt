...
class SitioActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var currentRole: Rol = ParseUser.getCurrentUser().get(com.descubre.kampa.Constantes.ID_ROL) as Rol
        ...
        registrarDenuncia.setOnClickListener{
            val intent = Intent(this, com.descubre.kampa.CrearDenunciaActivity::class.java)
        ...
        if(rolObject?.descripcion == com.descubre.kampa.Constantes.ADMINISTRADOR){
    ...
    private fun actualizarConWishlist(){
        ...
        query.whereEqualTo(com.descubre.kampa.Constantes.ID_SITIO, sitio)
                ...
                if (objects != null) {
                    ...
                    val builder = AlertDialog.Builder(this)
                        ...
                        .setItems(arr){dialog, which ->
                            ...
                            queryExisteEnWishlist.whereEqualTo(com.descubre.kampa.Constantes.ID_SITIO, sitio)
                            queryExisteEnWishlist.whereEqualTo(com.descubre.kampa.Constantes.ID_WISHLIST, objects[which])
    ...
    private fun goToEditarSitio() {
        ...
        editarSitio.putExtra(com.descubre.kampa.Constantes.PERMISSION, permission)
        editarSitio.putExtra(com.descubre.kampa.Constantes.SITIO, sitio)
    ...
    private fun verificarSitioVisitado(){
        ...
        querySitioVisitado.whereEqualTo(com.descubre.kampa.Constantes.ID_SITIO, sitio)
        querySitioVisitado.whereEqualTo(com.descubre.kampa.Constantes.ID_USUARIO, ParseUser.getCurrentUser())
